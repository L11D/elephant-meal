...
def f(driver, url):
    ...
    elements = WebDriverWait(driver, 20).until(
        EC.presence_of_all_elements_located((By.CSS_SELECTOR, '.UiKitText_Title1Tight'))
    )[0]
...
def main(urls):
    ...
    with ThreadPoolExecutor(max_workers=num_drivers) as executor:
        for _ in range(num_drivers):
            executor.submit(worker, url_queue, result_queue, driver_queue)
...
urls = ['https://eda.yandex.ru/retail/lenta/catalog/19280?placeSlug=lenta_quwrh',
        'https://eda.yandex.ru/retail/lenta/catalog/1034?placeSlug=giper_gwhxm',
        'https://eda.yandex.ru/retail/lenta/catalog/1033?placeSlug=giper_gwhxm',
        'https://eda.yandex.ru/retail/lenta/catalog/19280?placeSlug=lenta_quwrh',
        'https://eda.yandex.ru/retail/lenta/catalog/1034?placeSlug=giper_gwhxm',
        'https://eda.yandex.ru/retail/lenta/catalog/1033?placeSlug=giper_gwhxm',
'https://eda.yandex.ru/retail/lenta/catalog/19280?placeSlug=lenta_quwrh',
        'https://eda.yandex.ru/retail/lenta/catalog/1034?placeSlug=giper_gwhxm',
